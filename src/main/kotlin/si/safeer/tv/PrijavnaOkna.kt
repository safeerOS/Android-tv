 ...
 * res pelje na prijavo. Obljuba je, da delujejo vse strani, ne da je v kodi recept za
 * posamezno stran.
 *
 * Dve pravili:
 ...
 *
 * Vse drugo ostane preprecen oglas.
 *
 * Naslov razclenimo sami, brez android.net.Uri, da je pravilo mogoce preizkusiti na JVM
 * (tests/PrijavnaOknaTest.kt) in ne sele na televizorju.
 */
object PrijavnaOkna {

    /** Znani ponudniki prijave. Ujamemo tudi njihove poddomene. */
    ...
    private fun jeZnanPonudnik(gostitelj: String): Boolean {
        ...
        // Lastni prijavni streznik podjetja: accounts.*, login.*, signin.*, auth.*, sso.*
