# Safeer Browser for Android TV 2.1.106 · Safeer OS 0.2.6
...
- **Close programs from the TV.** Programs in the Continue row carry a visible ✕, and a "Close all" card closes every program started from the TV on the computer.
