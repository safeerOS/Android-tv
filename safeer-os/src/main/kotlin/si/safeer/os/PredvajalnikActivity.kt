...
class PredvajalnikActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_predvajalnik)
    ...
    private fun zazeni() {
        ...
        p.addListener(object : Player.Listener {
            override fun onIsPlayingChanged(isPlaying: Boolean) {
                stanjeIkona.setImageResource(if (isPlaying) R.drawable.ikona_pavza else R.drawable.ikona_predvajaj)
            ...
            override fun onPlayerError(error: PlaybackException) {
                Toast.makeText(this@PredvajalnikActivity, getString(R.string.predvajalnik_napaka, error.errorCodeName), Toast.LENGTH_LONG).show()
                finish()
            }
        })
